                ...
                <div class="overflow-x-auto">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <td class="px-4 py-3 sm:px-6 whitespace-nowrap">
                            ...
                            >
                                {{ item.borrower?.first_name.charAt(0).toUpperCase() }}{{ item.borrower?.last_name.charAt(0).toUpperCase() }}
                            </div>
...
<script setup>
    ...
    onMounted(async()=> {
        ...
        try{
            ...
            const res = await $fetch(`${config.public.sanctum.baseUrl}/getAllLoanAfterApproveforLender/${id}`, {
                headers: {
