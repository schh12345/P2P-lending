              ...
              <div v-if="transactions" class="p-4 sm:p-6 w-full  mt-6 md:mt-0">
                  ...
                  >
                      ...
                      <div class="flex items-start gap-4 w-full sm:w-auto flex-1">
                          ...
                          >
                          <span class="w-5 h-5 block" v-html="transaction.type === 'fund' ? getIcon('arrowDownLeft') : getIcon('arrowUpRight')"></span>
                          </div>
                      ...
                      <div class="text-right w-full sm:w-auto">
                          ...
                          >
                          {{ transaction.type === 'fund' ? '+' : '-' }}${{ formatAmount(transaction.amount) }}
                          </p>
...
<script setup>
  ...
  definePageMeta({
    ...
    onMounted(async()=> {
      ...
      try {
        const res = await $fetch(`${config.public.sanctum.baseUrl}/transactionForBorrower/${id}`, {
          headers: {
