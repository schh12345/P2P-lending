    ...
    <div class="p-4 md:p-8">
        ...
        <div class="w-full mx-auto md:flex md:justify-between gap-6 mb-8">
            ...
            <div class="p-6 space-y-6 w-full">
               ...
               <div v-if="loading" class="text-center text-gray-600 text-lg py-10">Loading loans...</div>

                <div v-else>
                    <div v-if="loans.length === 0" class="text-center text-gray-500 text-xl py-10">
                        No loan records found.
                    </div>

                    <div v-else class="space-y-10">
                        <div v-for="loan in loans" :key="loan.request_id" class=" bg-white p-4 sm:p-6 rounded-lg shadow-sm">
                            ...
                            <!-- status -->
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    :class="{
                                        ...
                                        'bg-green-200 text-green-800': loan.status === 'Approve',
...
<script setup>
    ...
    const {id}= await borrowerProfileData()
        ...
        onMounted(async()=> {
        try {
            const loanRes = await $fetch(`${config.public.sanctum.baseUrl}/allLoan/${id}`, {
            headers: {
