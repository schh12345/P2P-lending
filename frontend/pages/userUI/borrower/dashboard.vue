 ...
 <div class="space-y-2">
  ...
  <div class="p-4 md:p-8">
    ...
    <div class="mx-auto w-full md:flex md:justify-between gap-x-6">
      <!-- Total Balance Card -->
      <div class="border-1 border-gray-300 shadow-md bg-gradient-to-br from-[#0a0e2a] via-[#0c1e3a] to-[#081021] w-full rounded-2xl p-6 flex flex-row justify-center gap-x-5 lg:gap-x-100">
          
          <!--credit score-->
          <div>
            <div class="flex justify-between mt-5">
              <h2 class="text-lg font-semibold text-gray-100">Credit Score</h2>
              <div class="text-gray-100 w-10 h-10 bg-gray-300 rounded-full px-2 py-2 text-center">i</div>
            </div>

            <div class="relative my-6 w-40 h-40 mx-auto">
                <svg class="max-w-full max-h-full rotate-[-90deg]" viewBox="0 0 36 36">
                  <!-- Background circle -->
                  <path
                    d="M18 2.0845
                ...
                <div class="absolute top-1/6 left-1/2 transform -translate-x-1/2 translate-y-1/2 text-center">
          ...
          <div class="flex-col space-y-10">
            <div class="border-b-1 border-gray-300">
              ...
              <p v-if="amount" class="text-3xl font-bold text-gray-100 mt-2 md:ml-20 mb-5">${{ amount.balance }}</p>
            </div>
            ...
            <div class="flex justify-start gap-x-20">
              ...
              <div>
                <h2 class="text-md font-normal text-gray-100">Pay Back</h2>
  ...
  >
    ...
    <div class="mx-auto w-full mt-10 bg-white rounded-xl shadow-sm">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center p-5 gap-4">
        <h2 class="text-lg font-semibold text-gray-900">Start Request Now</h2>
        <NuxtLink 
...
try {
   await loanTracking() 
  const res= await $fetch(`${config.public.sanctum.baseUrl}/getBorrowerBalance/${id}`, {
    headers: {
