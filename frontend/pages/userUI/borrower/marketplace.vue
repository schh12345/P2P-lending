        ...
        <div class="p-4 md:p-8">
            ...
            <div class="max-w-7xl mx-auto bg-white">
                ...
                <div class="mx-auto max-w-7xl mt-10 bg-white rounded-xl shadow-sm">
                    ...
                    <div class="flex flex-col sm:flex-row justify-end items-start sm:items-center p-5 gap-4">
...
<script setup>
    ...
    const initial_first_name = computed(() => loans.value.borrower?.first_name.charAt(0).toUpperCase() || '')
    const initial_last_name = computed(() => loans.value.borrower?.last_name.charAt(0).toUpperCase() || '')
    console.log(initial_first_name)
