        ...
        <div class="p-4 space-y-2 overflow-y-auto h-[calc(100%-120px)]">
            ...
            <div class="space-y-1">
                ...
                <div v-if="open.pages" class="ml-4 space-y-1">
                    <button @click="navigateTo('/admin/pages/users/new-user')" :class="getClass('/admin/pages/users/new-user')">
                        <Users class="w-4 h-4" />
                        <span>New User</span>
                    </button>
            ...
            <div class="space-y-1">
                ...
                <div v-if="open.applications" class="ml-4 space-y-1">
                    <button @click="navigateTo('/admin/applications/loan-request')" :class="getClass('/admin/applications/loan-request')">
